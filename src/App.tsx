          ...
          >
            ...
            <div className="help-body">
              ...
              <section className="help-why">
                <h3>💡 なぜ Markdown からスライドを作るの？</h3>
                <p className="help-sub">
                  AI はスライドを直接作ることもできますが、いったん Markdown を経由するのには理由があります。
                </p>
                <ul>
                  <li>
                    <b>AI のトークンを大幅に節約</b> ― スライド一式（レイアウトや装飾込み）を直接生成させるより、
                    Markdown を書かせる方が圧倒的に少ないトークンで済みます（＝速い・安い）。
                  </li>
                  <li>
                    <b>微調整は AI に頼み直さず自分で</b> ― 位置・文字・表・フォントはこの画面でその場で無料で直せます。
                    少し直すたびに生成し直して、気に入っていた他の部分まで変わってしまう…がありません。
                  </li>
                  <li>
                    <b>本物の“編集できる”成果物</b> ― 画像ではなくネイティブのテキストボックス／表なので、
                    書き出した後も PowerPoint で自由に仕上げられます。
                  </li>
                  <li>
                    <b>AI は何でも OK・手書きも可</b> ― Markdown を出せる AI（ChatGPT / Claude / Gemini など）なら
                    どれでも使え、特定ツールに縛られません。自分で書いてももちろん OK。
                  </li>
                  <li>
