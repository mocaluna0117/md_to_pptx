          ...
          <div className="export-wrap" ref={settingsWrapRef}>
            ...
            {settingsOpen && (
              <div className="export-menu doc-settings" role="dialog" aria-label="文書設定">
                ...
                <p className="ds-note">
                  ヘッダー・本文フォント・目次はプレビュー / PDF にも反映されます。用紙サイズと余白は
                  Word 書き出し用。ページ番号は Word では各ページに付きます（PDF はブラウザ印刷の
                  制約で対象外）。目次の番号は Word で開いて F9 で更新してください。
                </p>
              </div>
            )}
          </div>
            ...
            <div className="help-body">
              ...
              <section>
                ...
                <ul>
                  ...
                  <li>
                    表の<b>列の境界をドラッグ</b>すると幅を変えられます（両端をドラッグすると表全体の幅・位置）。
                    <b>境界をダブルクリック</b>すると、その列の一番長い内容に合わせて幅が自動調整されます
                  </li>
